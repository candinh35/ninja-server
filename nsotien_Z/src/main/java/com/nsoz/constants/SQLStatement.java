...
public class SQLStatement {
    ...
    public static final String GET_USER = "SELECT `status`, activated ,received_first_gift, `id`, `luong`, `last_attendance_at`, `password`, kh, `ip_address`, `level_reward`, `role`, `efffan`, `effvip`, `efftop`, `effytb`, `effdg`, `effygt`, `effydc`, `nhanmocnap`, `effydh`, `online`, `ban_until`, `activated` FROM `users` WHERE `username` = ?;";
